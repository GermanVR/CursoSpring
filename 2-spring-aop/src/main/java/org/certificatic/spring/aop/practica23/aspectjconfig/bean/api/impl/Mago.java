...
public class Mago implements IAdivinador {
	...
	// el argumento
	@Pointcut("execution( public void org..IVoluntario.pensarEn*(String) ) && args(pensamiento)")
	...
	// argumento
	@Pointcut("execution( String org..IVoluntario.getP*(boolean) ) && args(hacerTrampa)")
