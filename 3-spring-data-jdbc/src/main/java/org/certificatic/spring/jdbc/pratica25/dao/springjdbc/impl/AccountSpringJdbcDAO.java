...
public class AccountSpringJdbcDAO extends GenericSpringJdbcDAO<Account, Long>
	...
	private static final String UPDATE_ACCOUNT_WHERE_ACCOUNT_ID = "UPDATE ACCOUNT_TBL SET ACCOUNT_NUMBER = ?, CREATED_DATE = ?, BALANCE = ? WHERE FK_CUSTOMER_ID = ?";
	...
	public List<Account> findByCustomerId(Long id) {
		...
		return this.jdbcTemplate.query(SELECT_ALL_ACCOUNT_WHERE_CUSTOMER_ID, 
	...
	public void update(Account account) {
		...
		this.jdbcTemplate.update(UPDATE_ACCOUNT_WHERE_ACCOUNT_ID, 
