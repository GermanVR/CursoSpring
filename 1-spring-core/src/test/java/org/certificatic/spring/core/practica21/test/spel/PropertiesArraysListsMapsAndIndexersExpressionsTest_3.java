...
public class PropertiesArraysListsMapsAndIndexersExpressionsTest_3 {
	...
	public void arraysSpelTest() {
		...
		// obtener el valor del invento posición 2 de Tesla
	...
	public void listSpelTest() {
		...
		// definir expresión que corresponda con obtener el valor del 
		// miembro posición 2 del contexto society
		...
		// utilizando el contexto society, 
		// obtener el nombre del invento posición 1 
		// del miembro posición 2, 
		// obtener utilizando el nombre de la función
		...
		// obtener el nombre del invento posición 1 
		// del miembro posición 2, 
		// obener utilizando posición en el arreglo
	...
	public void inlineListSpelTest() {
		...
		// definir y obtener el valor de una expresión 
		// que corresponda a la definición de una lista de enteros del 1 al 4
		...
		// definir y obtener el valor de una expresión 
		// que corresponda a la definición de una lista de listas de strings
