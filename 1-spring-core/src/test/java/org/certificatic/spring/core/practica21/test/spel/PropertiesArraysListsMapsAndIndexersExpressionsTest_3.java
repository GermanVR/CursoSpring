...
public class PropertiesArraysListsMapsAndIndexersExpressionsTest_3 {
	...
	public void propertiesSpelTest() {
		...
		String teslaName = spelParser.parseExpression("name").getValue(teslaContext, String.class); // definir y obtener
																									// el valor de la
																									// expresion "name"
																									// en el contexto
																									// teslaContext
		...
		int teslaBirthYear = spelParser.parseExpression("birthdate.year + 1900").getValue(teslaContext, Integer.class); // definir
																														// y
																														// obtener
																														// el
																														// valor
		...
		String teslaNationality = spelParser.parseExpression("nationality").getValue(teslaContext, String.class); // definir
																													// y
																													// obtener
																													// el
																													// valor
	...
	public void arraysSpelTest() {
		...
		String invention_2 = null; // definir expresi�n que corresponda con obtener el valor del invento posici�n 2
									// de Tesla
	...
	public void listSpelTest() {
		...
		Inventor teslaInventor = null; // definir expresi�n que corresponda con obtener el valor del miembro posici�n 2
		...
		String inventionName_1 = spelParser.parseExpression("getMembers()[2]").getValue(String.class); // utilizando el
																										// contexto
																										// society,
																										// obtener el
																										// nombre del
		...
		String otherInventionName_1 = null; // utilizando el contexto society, obtener el nombre del invento posici�n 1
											// del miembro posici�n 2, obener utilizando posici�n en el arreglo
	...
	public void inlineListSpelTest() {
		...
		List<Integer> listOfIntegers = spelParser.parseExpression("{1,2,3,4}").getValue(List.class); // definir y
																										// obtener el
																										// valor de una
																										// expresi�n que
																										// corresponda a
		...
		List<List<String>> listOfListOfStrings = (List<List<String>>) spelParser
				.parseExpression("{{'a','b'},{'c','d'}}").getValue(); // definir y obtener el valor de una expresi�n que
																		// corresponda a la definici�n de una lista de
																		// listas de strings
	...
	public void mapSpelTest() {
		...
		Inventor president = spelParser.parseExpression("officers['president']").getValue(societyContext,
				Inventor.class); // definir y obtener el inventor 'presidente' del mapa 'oficiales' del contexto
									// society
		...
		// definir y obtener el nombre de la ciudad de nacimiento del
		// inventor 'presidente' del mapa 'oficiales' del contexto society
		...
		// setter
		// definir y asignar el valor 'Croacia' como nueva ciudad de nacimiento el
		// inventor 'presidente' del mapa 'oficiales' del contexto society
		spelParser.parseExpression("officers['president'].placeOfBirth.city").setValue(societyContext, "Croacia");
		// definir y obtener el nombre de la ciudad de nacimiento del inventor
		// 'presidente' del mapa 'oficiales' del contexto society
