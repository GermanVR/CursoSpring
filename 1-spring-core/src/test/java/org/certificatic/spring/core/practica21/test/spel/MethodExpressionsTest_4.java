...
public class MethodExpressionsTest_4 {
	...
	public void methodExpressionsTest() {
		...
		// definir expresión substring que obtenga 
		// el valor esperado de Tesla
		...
		// definir expresión que verifique si 
		// 'Rudolf Carl Virchow' es miebro de la sociedad IEEE
		...
		// definir expresión que verifique si 
		// 'Charles Babbage' es miebro de la sociedad IEEE
